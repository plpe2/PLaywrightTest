...
test("Architectural Evaluation", async ({ page }) => {
  var archiTest = new Architectural(page, "NBP2605-00022");
...
test("Geodetic Evaluation", async ({ page }) => {
  var geoTest = new Geodetic(page, "NBP2605-00022");
...
test("Electrical Evaluation", async ({ page }) => {
  var elecTest = new Electrical(page, "NBP2605-00022");
...
test("Structural Evaluation", async ({ page }) => {
  var structTest = new Structural(page, "NBP2605-00022");
